...
export default function OceanografiaNKE() {
  return (
    <PageTransition>
      <PageHeader
        kicker="Oceanografia · NKE Instruments"
        title="Sondas e Data Loggers — WiMo e WiSens"
        subtitle="Duas linhas distintas: WiMo (sonda multiparamétrica) e WiSens (data loggers autónomos). Temperatura, pressão, CTD, oxigénio, clorofila-A, turbidez e mais."
        image="/assets/slide2.JPG"
        actions={[
          { label: 'Ver WiMo', href: '#wimo' },
          { label: 'Ver WiSens', href: '#wisens', ghost: true },
        ]}
      >
        <div className="flex flex-wrap gap-2 mt-6">
          {['WiMo — Sonda Multiparamétrica', 'WiSens — Data Loggers', 'Até 6000 m', 'Wi-Fi magnético', 'IP67'].map((b) => (
            <span
              key={b}
